...
目录树与 Squarified Treemap 并列展示，支持扩展名着色与钻取导航。

![树 + Treemap 主界面](docs/screenshots/treemap-overview.png)

### 清理中心 (Cleanup Hub)

12 类 Scour 风格扫描器：空目录、重复文件、大文件、临时文件等。

![清理中心](docs/screenshots/cleanup-hub.png)

### 全部文件

虚拟滚动的扁平文件索引，支持排序、筛选与正则搜索。

![全部文件](docs/screenshots/all-files.png)

### 深色主题

Material Design 深色/浅色主题，可自定义强调色。
...
Benchmark 说明见 [`tests/benchmark/README.md`](tests/benchmark/README.md)。

## 路线图 / 待完成

以下清理模块已注册但尚未实现（返回空结果）：
